...
class UnitTestingExtractData:
    def __init__(self, bag_file_path=None, gt_output_file_path='', vo_output_file_path='', folder_path=' ',
                 matching_mode='orb', starting_index=0, number_of_outputs=10):
        # set up flags
                ...
                if not self.first_topic_found:
                    ...
                    if topic != self.first_topic_found:
                        ...
                        if self.valid_count > 1 and gt_transformation is not None:
                            ...
                            valid_pair += 1
                            if valid_pair == self.starting_index:
                                previous_image_path = self.folder_path + "/set_" + str(valid_pair) + "_image.jpg"
...
def main(args):
    ...
    folder_path = '/home/ivyz/Documents/ivy_workspace/src/vis_odom/scripts/unit_testing/ut_08172023_I-matrix_start/output000-400-trial2'
