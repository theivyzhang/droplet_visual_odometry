...
def main(args):
    ...
    desktop_folder_path = '/home/ivyz/Documents/ivy_workspace/src/vis_odom/scripts/images/unit_testing_07262023'  # Replace with the actual folder path on your desktop\
    ...
    list_of_images_path = collect_images.output_image_paths[1:]
    ...
    TrajectoryEvaluation_VisOdom_Collect_Data(list_of_images_paths=list_of_images_path)
    print("trajectory estimation for visual odometry activated")
    rospy.sleep(1)
